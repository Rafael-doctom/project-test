...
export default function AtomListNav() {
    ...
    return (
        <>
            ...
            <ListItem
                onClick={() => setPortfolio(true)}>Portfólio
            </ListItem>
            {
                portfolioClick ?
                    <>
            ...
            <ListItem
                onClick={() => setHabilidades(true)}>Habilidades
            </ListItem>
            {
                habilidadesClick ?
                    <>
            ...
            <ListItem
                onClick={() => setContact(true)}>Contato
            </ListItem>
            {
                contactClick ?
                    <>
